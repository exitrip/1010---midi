...
#line 1 "itrip.h" /0
 ...
 void copyInterToData (byte dest[], byte source[]);
 void copyDataToInter (byte dest[], byte source[]);
 ...
 void testTXRX (byte error, byte vect);
 ...
 void CRCCheck (byte *MSB);
 void CRCGen	(byte *MSB);
 void CRC_ASM();
...
#line 19 "test\timers.c" /0
 
  
#line 1 "TEST\TIMERS.H" /0
...
#line 20 "test\timers.c" /0
 ...
 extern volatile byte inputBuf[0x06], inBuf[0x06], outBuf[0x06];
 ...
 volatile byte curBit = 8, outputSmoother = 3, outputByte = 0x06, outputBit = 8, *output;
 ...
 inputBuf[inputByte] = inputBuf[inputByte];   
